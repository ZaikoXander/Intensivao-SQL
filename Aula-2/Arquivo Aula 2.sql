...
-- SELECT, SELECT LIMIT, SELECT AS, SELECT DISTINCT 
...
SELECT DISTINCT estado FROM clientes; -- 11 estados, 27 - 11 == 16
...
SELECT nome_cliente AS "Nome:", data_criacao_conta AS "Data da criação da conta:" FROM clientes ORDER BY data_criacao_conta LIMIT 1;
...
-- Funções de Agregação: COUNT, COUNT *, COUNT DISTINCT, SUM, MIN, MAX, AVG
...
-- A coluna de notas tem valores nulos
